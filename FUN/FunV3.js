...
//-------------------------------------------------------------------------
//   PLEASE IGNORE EVERYTHING IN HERE!!!!!!!!!
//   I'VE COMMENTED EVERYTHING OUT AND I'M ONLY LEAVING IT IN FOR CONTEXT
//   THESE NO LONGER WORK AND ONLY ADD CLUTTER TO THE SCRIPT AND WORKFLOW
// -------------------------------------------------------------------------
...
offsetNJSOnNotesBetween(84, 100, 16, -0.25)

offsetNJSOnNotesBetween(105, 137, 16, -0.375)

offsetNJSOnNotesBetween(137, 161, 16, -0.25)

offsetNJSOnNotesBetween(161.1, 164.1, 14,-2) 

offsetNJSOnNotesBetween(164.2, 197.9, 16,-0.375)

offsetNJSOnNotesBetween(198, 199.25, 16, 0)
offsetNJSOnNotesBetween(199.3, 264.1, 16, -0.375)
offsetNJSOnNotesBetween(226.1, 131.5, 16, -0.25)
offsetNJSOnNotesBetween(257, 260.5, 16, -0.25)

offsetNJSOnNotesBetween(266.25, 295.75, 14, -2.0)
...
offsetNJSOnNotesBetween(331, 361, 16, -0.25)

offsetNJSOnNotesBetween(361, 397, 16, -0.375)

offsetNJSOnNotesBetween(397, 494, 18, -0.375)

offsetNJSOnNotesBetween(494.1, 1337, 16, -0.25)
...
filteredburstSliders = burstSliders.filter(bs => bs.b >= 178 && bs.b <= 181);
filteredburstSliders.forEach(burstSlider => {
  burstSlider.customData.track = "shlapper";
  burstSlider.customData.noteJumpStartBeatOffset = 4;
  burstSlider.customData.noteJumpMovementSpeed = 14;
  burstSlider.customData.spawnEffect = false;
  burstSlider.customData.animation = {}
  burstSlider.customData.animation.offsetPosition = [[rnd(-2,2)*0.1,rnd(-2,2)*0.1,-22,0], [0,0,0,0.4375, "easeInOutQuad"]];
  burstSlider.customData.animation.localRotation  = [[rnd(-35,35),rnd(-35,35),rnd(-55,55),0], [0,0,0,0.375, "easeOutBack"]];
  burstSlider.customData.animation.dissolveArrow = [[0,0], [1,0.375, "easeOutCubic"]];
  burstSlider.customData.animation.dissolve = [[0,0], [1,0.25, "easeOutCubic"]];
});
...
filteredburstSliders = burstSliders.filter(bs => bs.b >= 303 && bs.b <= 305);
filteredburstSliders.forEach(burstSlider => {
  burstSlider.customData.track = "shlapper";
  burstSlider.customData.noteJumpStartBeatOffset = 12;
  burstSlider.customData.noteJumpMovementSpeed = 16;
  burstSlider.customData.spawnEffect = false;
  burstSlider.customData.animation = {}
  burstSlider.customData.animation.offsetPosition = [[3,-1,-65,0], [0,0,0,0.4875, "easeInOutQuad"]];
  burstSlider.customData.animation.localRotation  = [[rnd(-65,65),rnd(-65,65),rnd(-89,89),0], [0,0,0,0.4875, "easeOutBack"]];
  burstSlider.customData.animation.dissolve = [[0,0.375], [1,0.4375, "easeInOutBounce"], [0.25,0.475, "easeInOutBounce"], [1,0.4875, "easeOutBounce"]];
  burstSlider.customData.animation.dissolveArrow = [[0,0], [1,0.4875, "easeInBounce"]];
});
...
filterednotes.forEach(slider => {
  if (slider.c == 0) {
    slider.customData.track = "slidurR";
    slider.customData.noteJumpStartBeatOffset = 0;
  }
  if (slider.c == 1) {
    slider.customData.track = "slidurB";
    slider.customData.noteJumpStartBeatOffset = 2;
  }
});
customEvents.push({ 
  b: 386,
